...
public class UpV extends javax.swing.JFrame {
...
int xMouse, yMouse;
    ...
    private void initComponents() {
        ...
        inisiar1.setText("MODIFICAR VENDEDOR");
        ...
        textbutom.setText("MODIFICAR VENDEDOR");
    ...
    private void textbutomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_textbutomMouseClicked
        ...
        if (j_codigo.getText().isEmpty() || j_name.getText().isEmpty() || j_caja.getText().isEmpty() || j_ventas.getText().isEmpty() || j_genero.getText().isEmpty() || j_pass.getText().isEmpty()) {
    ...
    private void enviar(){
        ...
        vendedoresM vm = new vendedoresM(Integer.parseInt(j_codigo.getText()), j_name.getText(), Integer.parseInt(j_caja.getText()), Integer.parseInt(j_ventas.getText()), j_genero.getText(), j_pass.getText());
        VendedoresDAORelacional vd = new VendedoresDAORelacional();
        vd.modificar_vendedor(vm);
